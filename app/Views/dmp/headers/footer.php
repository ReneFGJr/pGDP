    ...
    <div class="container p-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 mb-5 mb-md-0">
                <p>
                    <img src="<?= URL; ?>/img/logo/logo_pgd.png" class="img-fluid">
                </p>
                <p>
                    verão 0.22.07.10
                </p>
            ...
            <!--Grid column-->
            <div class="col-lg-1 col-md-1 mb-5 mb-md-0">
            </div>
                <!--Grid column-->
                ...
                <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="/about" class="text-white">Sobre o DCGP</a>
                        </li>
                        <li>
                            <a href="/contact" class="text-white">Contato</a>
                        </li>
                        <li>
                            <a href="/cited" class="text-white">Suporte</a>
                        </li>
                    </ul>
                </div>
