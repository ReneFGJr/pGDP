...
class messages extends CI_Model {
    ...
    function row($pg=0) {
        ...
        $form -> row_edit = base_url(PATH . 'config/message_editar');
        $form -> row_new = base_url(PATH . 'config/message_editar');
        $form -> row_view = base_url(PATH . 'config/message_view');
